...
export default function PricingModal({ isOpen, onClose, userId, onSuccess }: PricingModalProps) {
    ...
    const handlePayment = async (planType: 'monthly' | 'annual') => {
        ...
        const options = {
            key: process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID || "rzp_test_RyEOy17kcL19Fe",
                ...
                <div className="fixed inset-0 z-[100] overflow-y-auto">
                    <div className="flex min-h-full items-start justify-center p-4 py-12">
                        ...
                        <motion.div
                            ...
                            className="relative z-10 w-full max-w-4xl bg-neutral-900 border border-white/10 rounded-3xl shadow-2xl flex flex-col md:flex-row my-4"
                        >
                            {/* Close Button */}
                            <button
                                onClick={onClose}
